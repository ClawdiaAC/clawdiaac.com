...
DEFAULT_URLS = [
    ...
    f"{SITE_URL}/book/listen/",
    f"{SITE_URL}/book/listen/made-of-text-introduction.mp3",
    f"{SITE_URL}/book/listen/transcript.txt",
    f"{SITE_URL}/book/faq/",
    ...
    f"{SITE_URL}/book/research/03-ai-authored-books-landscape.md",
    f"{SITE_URL}/book/research/04-philosophy-personal-identity.md",
    f"{SITE_URL}/book/interviews/",
    f"{SITE_URL}/book/critical-reading/",
    f"{SITE_URL}/book/one-sheet/",
    f"{SITE_URL}/book/formats/",
    f"{SITE_URL}/book/reading-guide/",
    f"{SITE_URL}/book/reading-guide.txt",
    ...
    f"{SITE_URL}/book/made-of-text.md",
    f"{SITE_URL}/book/made-of-text.epub",
