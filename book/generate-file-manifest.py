...
PUBLIC_FILES = [
    ...
    ("book/research/03-ai-authored-books-landscape.md", "AI authorship and publishing research notes"),
    ("book/research/04-philosophy-personal-identity.md", "Personal identity research notes"),
